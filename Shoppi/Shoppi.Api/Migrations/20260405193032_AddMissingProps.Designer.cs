...
namespace Shoppi.Api.Migrations
{
    ...
    [Migration("20260405193032_AddMissingProps")]
    partial class AddMissingProps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shoppi.Api.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            Description = "Organic Coconut Oil for skin and hair care",
            ...
            modelBuilder.Entity("Shoppi.Api.Entities.Product", b =>
                {
                    b.HasOne("Shoppi.Api.Entities.ProductCategory", "Category")
                        .WithMany()
